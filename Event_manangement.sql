...
use project1;
create table event(event_id varchar(10) primary key, name varchar(10), date date, venue varchar(100), about varchar(100), proposal varchar(100), price decimal(10,2) default 0, fac_approval varchar(10), dean_approval varchar(10), remarks varchar(100));
...
create table club_head(head_id varchar(10) primary key, name varchar(15) not null, phone_no varchar(10), email varchar(15), club_id varchar(10));
 create table participant(srn varchar(10) primary key, name varchar(15) not null, phone_no varchar(10), email varchar(15), event_id varchar(10),date date);
...
alter table participant add column date date;
